      ...
      <nav className="w-full max-w-6xl bg-white/80 backdrop-blur-2xl border border-black/5 rounded-full px-6 md:px-10 py-2.5 md:py-3 shadow-[0_8px_30px_rgb(0,0,0,0.04)] pointer-events-auto relative">
        <div className="flex items-center justify-between">
          ...
          <div className="flex-1 flex items-center justify-end gap-4 md:gap-6">
            ...
            {/* Desktop CTA */}
            <a 
              href="https://wa.me/4915510731921?text=Hello%2C%20I’m%20interested%20in%20your%20services."
              target="_blank"
      ...
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
          ...
          <div className="bg-brand-gray p-8 md:p-12 rounded-[24px] md:rounded-[32px] border border-black/5 flex flex-col h-full hover:border-black/20 transition-all duration-300 transform hover:-translate-y-1 text-left">
            ...
            <a href="https://wa.me/4915510731921" target="_blank" rel="noopener noreferrer" className="w-full py-4 rounded-full border border-black/10 hover:bg-black/5 font-bold text-xs md:text-sm transition-all block text-center text-black">
          ...
          <div className="bg-brand-dark p-8 md:p-12 rounded-[24px] md:rounded-[32px] border border-white/5 flex flex-col relative md:-translate-y-6 shadow-2xl shadow-black/20 z-10 hover:-translate-y-8 transition-all duration-300 text-left">
            ...
            <a href="https://wa.me/4915510731921" target="_blank" rel="noopener noreferrer" className="w-full py-4 rounded-full bg-white text-black border-transparent hover:opacity-90 font-bold text-xs md:text-sm transition-all block text-center">
...
const ServicesPage = ({ lang }: { lang: Language }) => {
  ...
  const getWaLink = (serviceTitle: string) => {
    ...
    return `https://wa.me/4915510731921?text=${encodeURIComponent(message)}`;
  };
  ...
  return (
    <div className="min-h-screen bg-[#F9F9FB]">
      ...
      <section className="border-t border-[rgba(0,0,0,0.06)] py-32 text-center px-6 mt-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <a href="https://wa.me/4915510731921?text=Hello%2C%20I’m%20interested%20in%20your%20services." target="_blank" rel="noopener noreferrer" className="bg-black text-white px-10 py-5 rounded-full font-bold hover:opacity-90 transition-opacity w-full sm:w-auto inline-block text-center shadow-lg shadow-black/10">{s.cta.primary}</a>
              <a href="https://wa.me/4915510731921?text=Hello%2C%20I’m%20interested%20in%20your%20services." target="_blank" rel="noopener noreferrer" className="bg-white border border-black/10 text-black px-10 py-5 rounded-full font-bold hover:bg-black/5 transition-colors w-full sm:w-auto inline-block text-center">
                  {s.cta.secondary}
              </a>
          </div>
      </section>
    ...
    <div className="min-h-screen bg-[#F5F5F7]">
      ...
      <section className="pt-[200px] pb-[80px] text-center px-6 md:px-10">
          <div className="max-w-[1100px] mx-auto">
              ...
              >
                  <a href="https://wa.me/4915510731921" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center px-8 py-4 bg-brand-dark text-white rounded-full font-medium hover:opacity-90 transition-opacity w-full sm:w-auto text-center">
      ...
      <section className="pb-[120px] px-6 md:px-10">
          <div className="max-w-[1100px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-7">
              ...
              {/* WhatsApp Card */}
              <a href="https://wa.me/4915510731921" target="_blank" rel="noopener noreferrer" className="group bg-white p-10 rounded-[24px] border border-[rgba(0,0,0,0.06)] hover-card-shadow transition-all duration-300 transform hover:-translate-y-1 cursor-pointer flex flex-col h-full">
                  ...
                  <p className="text-[15px] text-[#636366] mb-8 flex-grow">+49 155 10731921</p>
              ...
              <a href="https://maps.google.com/?q=Rosenthaler+Str+33+10178+Berlin" target="_blank" rel="noopener noreferrer" className="group bg-white p-10 rounded-[24px] border border-[rgba(0,0,0,0.06)] hover-card-shadow transition-all duration-300 transform hover:-translate-y-1 cursor-pointer flex flex-col h-full relative overflow-hidden">
                  ...
                  <p className="text-[15px] text-[#636366] mb-8 relative z-10">Rosenthaler Str 33<br />10178 Berlin</p>
      ...
      <section className="max-w-[1100px] mx-auto px-6 md:px-10 mb-[120px]">
          <div className="bg-[#111111] rounded-[32px] py-[100px] md:py-[120px] px-8 text-center relative overflow-hidden border border-white/5">
              <div className="max-w-[800px] mx-auto relative z-10">
                  ...
                  <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                      <a href="https://wa.me/4915510731921" target="_blank" rel="noopener noreferrer" className="bg-white text-black px-10 py-5 rounded-full font-bold hover:opacity-90 transition-opacity w-full sm:w-auto inline-block text-center shadow-xl shadow-black/20">
                          {c.nextSteps.primary}
                      </a>
                  </div>
              </div>
